...
public class ServeurUDP {
    ...
    public static void main(String args[]) throws SocketException, IOException, InterruptedException {
        ...
        ListeUtilisateurs.add(new Utilisateur("killian","mot de passe")); //on ajoute certains nom dans la liste (remplire la base de données)
        ListeUtilisateurs.add(new Utilisateur("thomasbis","MdP"));
        ListeUtilisateurs.add(new Utilisateur("thomas","raynaud"));
        ListeUtilisateurs.add(new Utilisateur("Clement","motDePasse"));
        ...
        while(true){
            ...
            System.out.println("Paquet recu ==>  "+s) ; //afficher inscription,thomas
            ...
            if(t[0].equals("inscription")){ //on va voir quel type -> inscription
                ...
                if(ListeUtilisateurs.size()<10){
                    ...
                    if (exists==false){ //quand on est sur que l'utilisateur n'existe pas
                        ...
                        inscription=true; //on peut passer à l'inscription car la valeur était fausse avant
                    }
                }
                if(inscription){ //on passe à la confirmation de l'inscription au client
                    String msg2=t[1]+" , l inscription est reussie !"; //le message à renvoyer au client est celui là
                    ...
                    System.out.println("--> L'inscription de "+t[1]+" est validee.\n\n");//met sur le serveur que l'inscription est bonne (validation console)
                }
            }
